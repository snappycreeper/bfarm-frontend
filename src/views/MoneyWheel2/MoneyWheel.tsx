...
import { getJewelAddress } from '../../utils/addressHelpers'
...
const MoneyWheel: React.FC = () => {
  const cakeBalance = (useTokenBalance(getJewelAddress()))
    ...
    <div>
      ...
      <Page>
        <Cards>
            ...
            <div>
              <BetCard max={new BigNumber(cakeBalance)} tokenName="JEWEL" onResult={onResult}/>
            </div>
          </Cards>
      </Page>
    </div>
