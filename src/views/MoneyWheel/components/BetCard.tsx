...
import { getFullDisplayBalance9Decimals } from 'utils/formatBalance'
...
const BetCard: React.FC<BetCardProps> = ({max, tokenName = '', onResult}) => {
    ...
    const fullBalance = useMemo(() => {
        return getFullDisplayBalance9Decimals(max)
      }, [max])

    return (
        <div>
            <Heading as="h1" size="lg" color="white" mb="50px" mt="30px" style={{ textAlign: 'left' }}>
                {TranslateString(999, "Make your bet wisely, we can't refund your BabyJewel!")}
            </Heading>
            <Flex>
                <BetInput
